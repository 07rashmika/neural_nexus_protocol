class Agent {
  ...
  Agent copyWith({
    String? username, String? avatarUrl, String? callsign,
    String? country, bool? profileComplete, double? intelPoints,
    int? level, String? position, int? streak, int? shieldCount, int? chainMultiplier,
  }) {
    return Agent(
      id: id, email: email, sessionToken: sessionToken,
